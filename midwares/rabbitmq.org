...
#+HTML: <img src="https://www.rabbitmq.com/img/tutorials/intro/hello-world-example-routing.png"/>
...
#+BEGIN_SRC plantuml :file img/rabbitmq_consume.png :eval never-export
  hide footbox
